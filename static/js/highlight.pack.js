...
!function (e) {
    ...
    var f = [], u = Object.keys, N = {}, c = {}, n = /^(no-?highlight|plain|text)$/i, s = /\blang(?:uage)?-([\w-]+)\b/i,
        t = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, r = {
            case_insensitive: "cI",
            lexemes: "l",
            contains: "c",
            ...
            terminators: "t",
            terminator_end: "tE"
        }, b = "</span>", h = {classPrefix: "hljs-", tabReplace: null, useBR: !1, languages: void 0};
    ...
    function R(e) {
        ...
        return function e(n, t) {
            for (var r = n.firstChild; r; r = r.nextSibling) 3 === r.nodeType ? t += r.nodeValue.length : 1 === r.nodeType && (a.push({
                ...
                offset: t,
                node: r
            }), t = e(r, t), E(r).match(/br|hr|img|input/) || a.push({event: "stop", offset: t, node: r}));
            return t
        }(e, 0), a
    }
    ...
    function o(e) {
        var n, t, r, a, i, o = function (e) {
            ...
            for (n = 0, r = (i = i.split(/\s+/)).length; n < r; n++) if (l(a = i[n]) || B(a)) return a
        }(e);
...
hljs.registerLanguage("python", function (e) {
    var r = {
            ...
            v: [{b: /(u|b)?r?'''/, e: /'''/, c: [e.BE, b], r: 10}, {
                ...
                b: /(b|br)"/,
                e: /"/
            }, {b: /(fr|rf|f)'/, e: /'/, c: [e.BE, c]}, {b: /(fr|rf|f)"/, e: /"/, c: [e.BE, c]}, e.ASM, e.QSM]
...
hljs.registerLanguage("properties", function (r) {
    ...
    return {
        ...
        c: [r.C("^\\s*[!#]", "$"), {
            ...
            starts: a
        }, {b: n + e, rB: !0, r: 0, c: [{cN: "meta", b: n, endsParent: !0, r: 0}], starts: a}, {
            cN: "attr",
            r: 0,
            b: n + t + "$"
        }]
...
hljs.registerLanguage("objectivec", function (e) {
    var t = /[a-zA-Z@][a-zA-Z0-9_]*/, _ = "@interface @class @protocol @implementation";
    return {
...
hljs.registerLanguage("ruby", function (e) {
    ...
    return {aliases: ["rb", "gemspec", "podspec", "thor", "irb"], k: r, i: /\/\*/, c: s.concat(l).concat(d)}
});
...
hljs.registerLanguage("css", function (e) {
    ...
    return {
        ...
        }, {cN: "selector-tag", b: "[a-zA-Z-][a-zA-Z0-9_-]*", r: 0}, {b: "{", e: "}", i: /\S/, c: [e.CBCM, c]}]
    }
});
...
hljs.registerLanguage("xml", function (s) {
    ...
    return {
        ...
        c: [{
            ...
            r: 10,
            c: [{b: "\\[", e: "\\]"}]
        }, s.C("\x3c!--", "--\x3e", {r: 10}), {b: "<\\!\\[CDATA\\[", e: "\\]\\]>", r: 10}, {
            cN: "meta",
            b: /<\?xml/,
            e: /\?>/,
            r: 10
...
hljs.registerLanguage("cs", function (e) {
    var i = {
            ...
            r: 0
        }, t = {cN: "string", b: '@"', e: '"', c: [{b: '""'}]}, a = e.inherit(t, {i: /\n/}),
        c = {cN: "subst", b: "{", e: "}", k: i}, n = e.inherit(c, {i: /\n/}),
        s = {cN: "string", b: /\$"/, e: '"', i: /\n/, c: [{b: "{{"}, {b: "}}"}, e.BE, n]},
        b = {cN: "string", b: /\$@"/, e: '"', c: [{b: "{{"}, {b: "}}"}, {b: '""'}, c]},
        l = e.inherit(b, {i: /\n/, c: [{b: "{{"}, {b: "}}"}, {b: '""'}, n]});
    c.c = [b, s, t, e.ASM, e.QSM, r, e.CBCM], n.c = [l, s, a, e.ASM, e.QSM, r, e.inherit(e.CBCM, {i: /\n/})];
    var o = {v: [b, s, t, e.ASM, e.QSM]}, d = e.IR + "(<" + e.IR + "(\\s*,\\s*" + e.IR + ")*>)?(\\[\\])?";
    return {
        aliases: ["csharp", "c#"],
        k: i,
        i: /::/,
        ...
        }, o, r, {bK: "class interface", e: /[{;=]/, i: /[^\s:,]/, c: [e.TM, e.CLCM, e.CBCM]}, {
            bK: "namespace",
            e: /[{;=]/,
            i: /[^\s:]/,
...
hljs.registerLanguage("javascript", function (e) {
    var r = "[A-Za-z$_][0-9A-Za-z$_]*", a = {
        ...
        n = {cN: "subst", b: "\\$\\{", e: "\\}", k: a, c: []}, c = {cN: "string", b: "`", e: "`", c: [e.BE, n]};
    ...
    return {
        ...
        c: [{cN: "meta", r: 10, b: /^\s*['"]use (strict|asm)['"]/}, {
            ...
            c: [e.CLCM, e.CBCM, e.RM, {
                ...
                rB: !0,
                e: "\\s*=>",
                c: [{cN: "params", v: [{b: r}, {b: /\(\s*\)/}, {b: /\(/, e: /\)/, eB: !0, eE: !0, k: a, c: s}]}]
            }, {cN: "", b: /\s/, e: /\s*/, skip: !0}, {
                b: /</,
    ...
    return {
        ...
        c: n.concat([i, {
            ...
            c: [{b: a, rB: !0, c: [t.TM], r: 0}, {
                ...
                k: c,
                r: 0,
                c: [t.CLCM, t.CBCM, r, s, e, {b: /\(/, e: /\)/, k: c, r: 0, c: ["self", t.CLCM, t.CBCM, r, s, e]}]
            }, t.CLCM, t.CBCM, i]
